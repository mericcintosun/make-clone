        ...
        <div className="h-full overflow-y-auto">
          <div className="p-4 sm:p-6 pb-8">
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="text-gray-500 text-xs sm:text-sm font-medium mb-3 sm:mb-4 tracking-wider">WHAT IS MAKE</h3>
              <ul className="space-y-3 sm:space-y-4">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Product overview</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Apps</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Enterprise</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">About us</span>
                </li>
              </ul>
            </div>
            ...
            {/* MAKE + AI Section */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-gray-500 text-xs sm:text-sm font-medium mb-3 sm:mb-4 tracking-wider">MAKE + AI</h3>
              <ul className="space-y-3 sm:space-y-4">
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Automation with AI</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Agentic automation</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Make AI Agents</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Make AI apps</span>
                </li>
              </ul>
            </div>
            ...
            {/* SOLUTIONS Section */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-gray-500 text-xs sm:text-sm font-medium mb-3 sm:mb-4 tracking-wider">SOLUTIONS</h3>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Make across your business</h2>
              ...
              <div className="grid grid-cols-1 gap-3 sm:gap-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Marketing</span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Sales</span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Operations</span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Customer Experience</span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Finance</span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Information Technology</span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">People</span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Workplace Productivity</span>
                </div>
              </div>
            </div>
            ...
            {/* RESOURCES Section */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-gray-500 text-xs sm:text-sm font-medium mb-3 sm:mb-4 tracking-wider">RESOURCES</h3>
              <ul className="space-y-3 sm:space-y-4">
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Blog</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Success stories</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">How-to guides</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Templates library</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Make Academy</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Make Community</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Help center</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Webinars</span>
                </li>
              </ul>
            </div>
            ...
            {/* PARTNERS Section */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-gray-500 text-xs sm:text-sm font-medium mb-3 sm:mb-4 tracking-wider">PARTNERS</h3>
              <ul className="space-y-3 sm:space-y-4">
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Find a partner</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Become a partner</span>
                </li>
              </ul>
            </div>
            ...
            {/* PRICING Section */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-gray-500 text-xs sm:text-sm font-medium mb-3 sm:mb-4 tracking-wider">PRICING</h3>
              <ul className="space-y-3 sm:space-y-4">
                <li className="flex items-center space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center flex-shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-medium">Pricing</span>
                </li>
              </ul>
            </div>
            ...
            <div className="mb-6 sm:mb-8">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Talk to sales</h2>
              
              <div className="space-y-3 sm:space-y-4">
                {/* Log in Button */}
                <button className="w-full py-3 px-6 border-2 border-purple-500 text-purple-500 rounded-lg font-medium text-base sm:text-lg hover:bg-purple-50 transition-colors">
                  Log in
                </button>

                {/* Get started free Button */}
                <button className="w-full py-3 px-6 bg-pink-500 text-white rounded-lg font-medium text-base sm:text-lg hover:bg-pink-600 transition-colors">
                  Get started free
                </button>
              </div>
            </div>
